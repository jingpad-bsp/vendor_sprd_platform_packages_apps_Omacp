...
public class OtaMapData extends HashMap<Integer, ArrayList<MyHashMap>> {
    ...
    private boolean checkType(int nType) {
        switch (nType) {
            ...
            case Define.CHAR_VODAFONEVOWIFI:
            case Define.TYPE_VOWIFI:
                return true;
            default:
    ...
    public static final int nType[] = new int[] {
            ...
            Define.CHAR_PORT,
            Define.CHAR_ACCESS,
            Define.CHAR_PXLOGICAL,
            Define.CHAR_BOOTSTRAP,
            Define.CHAR_APPLICATION,
            Define.CHAR_CLIENTIDENTITY,
            Define.CHAR_VENDORCONFIG,
            Define.TYPE_APN,
            Define.TYPE_EMAIL,
            Define.TYPE_BOOKMARK,
            Define.TYPE_STARTPAGE,
            Define.TYPE_BROWSE,
            Define.TYPE_MMS,
            Define.TYPE_EXCHANGE,
            Define.CHAR_VODAFONEVOWIFI,
            Define.TYPE_VOWIFI
    };
