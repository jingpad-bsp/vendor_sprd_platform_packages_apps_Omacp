...
public class Define {
    ...
    public static final int CHAR_VODAFONEVOWIFI =9;
    ...
    public static final int TYPE_VOWIFI = 17;
    // define BootStrap data
    public static final String PROXY_ID = "proxy-id";

    //define VOWIFI data
    public static final String EPDGFQDN = "epdg fqdn";
    ...
    public final static String ACTION_VOWIFI = "com.andorid.VowifiDataConfig";
