...
public class OtaOmaService extends Service {
    ...
    private void process() {
        ...
        if (getOtaManager().checkIsNetwpin() && OmacpUtils.isVodafone(this)) {//for bug852734
                otaParse("");
    ...
    private AlertDialog.Builder createConfirmDialog() {
        ...
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.ota_dialog,nullParent);
