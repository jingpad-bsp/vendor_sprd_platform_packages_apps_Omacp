            ...
            if (intent.getAction().equals(WAP_PUSH_RECEIVED_ACTION)) {
                ...
                if (isUseNewOmacp(context)) {
                    ...
                    PowerManager.WakeLock wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK,
                            "MMS PushReceiver");
                    wl.acquire(5000);
                    if((OmacpUtils.checkSec(intent) == OtaPreParser.SEC_TYPE_NETWPIN) && OmacpUtils.isVodafone(context)){//for bug852734
                        Log.d(TAG, "vodafone and netwpin jump ");
                    ...
                    OmacpUtils.addComfrimDialogNotification(context, intent);
                }
            }
        }
    }
